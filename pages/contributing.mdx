...
Contributions are made to the [HausDAO/monorepo](https://github.com/HausDAO/monorepo) via Issues and Pull Requests (PRs).

## Issues

- [Monorepo Issues](https://github.com/HausDAO/monorepo/issues)
- [DAO App Starter Issues](https://github.com/HausDAO/dao-app-starter-vite/issues)

**Contract Repos**

- [Baal Contract Issues](https://github.com/HausDAO/Baal/issues)
- [Baal Token Issues](https://github.com/HausDAO/baal-tokens/issues)
- [Shamans Issues](https://github.com/HausDAO/baal-shamans/issues)
...
In general, we follow the [Fork and Pull Request Workflow](https://github.com/susam/gitpr)
...
Our monorepos use [Nx](https://nx.dev/) as a build system and for scaffolding. If this is your first time using Nx, you'll have to install it globally on your system:
